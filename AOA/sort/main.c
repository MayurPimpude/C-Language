...
//          printf("%d\n",arr[i]);
    ...
    printf("\n----------------------------------------------------------------------------");
    printf("\n\t      |  Merge sort  |\tQuick sort  |\tSelection  |\tInsertion  |");
    printf("\n----------------------------------------------------------------------------");
    printf("\n number0.dat  |\t %f   |\t%f    |\t   %d \t |\t%d \t|",M_difference[0],Q_difference[0],S_difference[0],I_difference[0]);
    printf("\n----------------------------------------------------------------------------");
    printf("\n number1.dat  |\t %f   |\t%f    |\t   %d \t |\t%d \t|",M_difference[1],Q_difference[1],S_difference[1],I_difference[1]);
    printf("\n----------------------------------------------------------------------------");
    printf("\n number2.dat  |\t %f   |\t%f    |\t   %d \t |\t%d \t|",M_difference[2],Q_difference[2],S_difference[2],I_difference[2]);
    printf("\n----------------------------------------------------------------------------");
    printf("\n number3.dat  |\t %f   |\t%f    |\t   %d \t |\t%d \t|",M_difference[3],Q_difference[3],S_difference[3],I_difference[3]);
    printf("\n----------------------------------------------------------------------------");
    printf("\n number4.dat  |\t %f   |\t%f    |\t   %d \t |\t%d \t|",M_difference[4],Q_difference[4],S_difference[4],I_difference[4]);
    printf("\n----------------------------------------------------------------------------");
